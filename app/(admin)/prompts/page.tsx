...
import { useRouter } from "next/navigation"; // eslint-disable-line
import Link from "next/link";
import { toast } from "sonner";
import { FIND_BY_CRITERIA, DELETE_PROMPT } from "@/features/prompts/graphql";
import { Prompt, PaginatedPrompts } from "@/features/prompts/types";
...
export default function PromptsPage() {
  ...
  const { data, loading, refetch } = useQuery<{ findByCriteria: PaginatedPrompts }>(FIND_BY_CRITERIA, { client: promptsClient,
